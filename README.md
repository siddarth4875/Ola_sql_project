# Ola_sql_project
This repository is about the data analysis of Ola booking.csv file using  # Excel # Mysql
OLA Cab Ride Data Analysis using SQL
<img width="900" height="600" alt="ola logo -3" src="https://github.com/user-attachments/assets/f4dd57d4-3af2-4882-bd83-3f2ca097aaac" />
...
Customer and Driver Cancellations: Customer-initiated cancellations are higher than driver cancellations, which suggests customer indecision or fare issues.The primary reason for driver cancellations is personal and car-related issues, highlighting a need for vehicle maintenance and driver availability improvements.
